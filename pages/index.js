...
let trendSec = document.querySelectorAll(".slider")
...
let cardMaker = (data,trendSec,term) => {
    let count = 1
...
cardMaker(data, trendSec[0],1)
cardMaker(data, trendSec[1],2)
